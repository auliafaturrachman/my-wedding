...
(function (global, factory) {
	...
	function calcSize(innerSize, minSize, maxSize) {
		return Math.floor(
			interpolation(innerSize, 0, maxInnerSize, minSize, maxSize)
		);
	}
	...
	var imagesStyle =
		'.snowflakes_gid_value .snowflake__inner_type_0:before{background-image:url("../image/prewedding/petal/petal-1.png")}.snowflakes_gid_value .snowflake__inner_type_1:before{background-image:url("../image/prewedding/petal/petal-2.png")}.snowflakes_gid_value .snowflake__inner_type_2:before{background-image:url("../image/prewedding/petal/petal-3.png")}.snowflakes_gid_value .snowflake__inner_type_3:before{background-image:url("../image/prewedding/petal/petal-4.png")}.snowflakes_gid_value .snowflake__inner_type_4:before{background-image:url("../image/prewedding/petal/petal-5.png")}.snowflakes_gid_value .snowflake__inner_type_5:before{background-image:url("../image/prewedding/petal/petal-6.png")}';
